...
struct segment_tree{int v;int ls,rs;}t[MAX*20];//线段树开nlogn大小
struct operation{bool b;int l,r,k;int pos,t;}q[5 *MAX];//因为要离散花所以要把所有数据输进来离线搞
int n,m,a[10 *MAX],o[10 *MAX],rt[5 *MAX],len,tot,temp[2][20],cnt[2];
char opt;
